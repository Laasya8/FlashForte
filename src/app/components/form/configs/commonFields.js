export const REGISTRATION_FIELDS = [
  ...
  { name: "rollNo", label: "Roll Number", type: "text", required: true, placeholder: "Enter your roll number", pattern: "^[a-zA-Z0-9]+$", patternMessage: "Please enter a valid alphanumeric roll number." },
